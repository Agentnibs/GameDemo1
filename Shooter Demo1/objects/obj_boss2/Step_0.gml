	...
	if (cooldown <= 0 && active = true && y > 100 && alive = true) {
	...
	if (alive = true){
		alive = false;
		global.theScore = global.theScore + 200000; //with (obj_score)
		alarm[1] = 60;
		...
		instance_create_layer(x+5, y+3, "Explosion", obj_boss_explosion);
		instance_create_layer(x+100, y-15, "Explosion", obj_boss_explosion);
